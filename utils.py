...
# DATASET_CONFIG = {
#     "fivejets":   {"ori_dim": [128, 128, 128], "total_samples": 1, "downsample_factor": 4},
#     "vortex":     {"ori_dim": [128, 128, 128], "total_samples": 1, "downsample_factor": 4},
#     "tornado":    {"ori_dim": [128, 128, 128], "total_samples": 1, "downsample_factor": 4},
#     "h2":         {"ori_dim": [600, 248, 248], "total_samples": 1, "downsample_factor": 32},
#     "T":          {"ori_dim": [600, 248, 248], "total_samples": 1, "downsample_factor": 32},
#     "tangaroa":   {"ori_dim": [300, 180, 120], "total_samples": 1, "downsample_factor": 8},
#     "bubble":     {"ori_dim": [640, 256, 256], "total_samples": 1, "downsample_factor": 32},
#     "halfcy":     {"ori_dim": [640, 240, 80],  "total_samples": 1, "downsample_factor": 16},
#     "combustion": {"ori_dim": [480, 720, 120], "total_samples": 1, "downsample_factor": 32},
#     "yoh":        {"ori_dim": [480, 720, 120], "total_samples": 1, "downsample_factor": 32},
#     "supernova":  {"ori_dim": [204, 204, 204], "total_samples": 1, "downsample_factor": 16},
# }

# def dataset_selection(dataset, spatial, temporal):
...
#     return ori_dim, total_samples, data_path, downsample_factor
...
DATASET_CONFIG = {
    ...
    "yoh":        {"ori_dim": [480, 720, 120], "total_samples": 1, "downsample_factor": 32},
    "supernova":  {"ori_dim": [204, 204, 204], "total_samples": 1, "downsample_factor": 16},
    "magnetic":   {"ori_dim": [512, 512, 512], "total_samples": 1, "downsample_factor": 64},
}
...
def dataset_selection(dataset, spatial, temporal):
    ...
    if spatial == 1:
        ...
        data_path = DATASET_DIR / dataset / "down"
        downsample_factor = config["downsample_factor"] // 4
    else:
        raise ValueError(f"Unsupported spatial value: {spatial}")
